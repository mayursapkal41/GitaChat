...
def generate_response_from_gita(user_query):
    prompt = (
        ...
        f"Give a peaceful, simple answer in 3-5 lines based on Gita teachings.and before that, write a predined text like The question you have asked is not directly addressed in the Bhagavad Gita, but we will still provide you with a solution."
    )
    try:
